                ...
                <div class="col">
                    <div class="card h-100" style="width: 18rem; margin-bottom: 10px;">
                        ...
                        <div style="display: flex; justify-content: space-around; margin: 5px;">
                            <button class="btn btn-primary">Ajouter au panier <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
